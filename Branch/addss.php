...
$query = @mysql_query("select * from sundays where  mobile = '$mobile'  ")or die(mysql_error());
...
mysql_query("insert into sundays(fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,thumbnail) 
