    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=mysql_query("select * from offering");
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = mysql_query("SELECT *FROm members  LEFT OUTER JOIN offering ON members.id = offering.na WHERE offering.offeringid !='' ")or die(mysql_error());
