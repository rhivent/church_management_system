    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=mysql_query("select * from tithe");
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = mysql_query("SELECT *FROm members  LEFT OUTER JOIN tithe ON members.id = tithe.na WHERE tithe.titheid !='' ")or die(mysql_error());
