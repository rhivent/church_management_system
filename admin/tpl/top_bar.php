	...
	<div id="top-bar">
		...
		<div class="page-full-width cf">
			...
			<ul id="nav" class="fl">
				...
				<li class="v-sep"><a href="#" class="round button dark menu-user image-left">Logged in as <strong><?php echo $GPOS['username'] ?></strong></a>
					<ul>
			...
			<form action="#" method="POST" id="search-form" class="fr">
				<fieldset>
                                    <a href="logout.php" class="round button dark menu-logoff image-left" style="background-color: #03F">Log out</a>
				</fieldset>
			</form>
