    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_user=mysql_query("select * from offering where na='$session_id'");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from members INNER JOIN offering ON members.id=offering.na where na='$session_id'")or die(mysql_error());
