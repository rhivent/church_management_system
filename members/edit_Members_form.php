...
mysql_query("update members set fname = '$fname',sname ='$sname',lname='$lname',Gender='$Gender',Birthday='$birthday', Residence='$residence',pob='$pob',ministry='$ministry',mobile='$mobile',email='$email',password='$password' where id='$get_member_id'") 
or die(mysql_error());
