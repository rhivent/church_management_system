    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=mysql_query("select * from giving where na='$session_id'");
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = mysql_query("SELECT *FROm members  LEFT OUTER JOIN giving ON members.id = giving.na WHERE giving.na ='$session_id' ")or die(mysql_error());
